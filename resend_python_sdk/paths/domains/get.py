...
from resend_python_sdk.model.list_domains_response import ListDomainsResponse as ListDomainsResponseSchema

from resend_python_sdk.type.list_domains_response import ListDomainsResponse

from ...api_client import Dictionary
from resend_python_sdk.pydantic.list_domains_response import ListDomainsResponse as ListDomainsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ListDomainsResponseSchema
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListDomainsResponsePydantic:
        raw_response = await self.raw.aget_list(
            **kwargs,
        )
        if validate:
            return ListDomainsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListDomainsResponsePydantic, raw_response.body)
